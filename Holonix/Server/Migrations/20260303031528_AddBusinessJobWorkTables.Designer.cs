...
namespace Holonix.Server.Migrations
{
    ...
    [Migration("20260303031528_AddBusinessJobWorkTables")]
    partial class AddBusinessJobWorkTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Holonix.Server.Domain.Entities.Business", b =>
                {
                    ...
                    b.Property<bool>("IsSingleService")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Holonix.Server.Domain.Entities.Sport", b =>
                {
            ...
            modelBuilder.Entity("Holonix.Server.Domain.Entities.Team", b =>
                {
            ...
            modelBuilder.Entity("Holonix.Server.Domain.Entities.Team", b =>
                {
                    b.HasOne("Holonix.Server.Domain.Entities.Sport", "Sport")
                        .WithMany()
            ...
            modelBuilder.Entity("Holonix.Server.Domain.Entities.Workload", b =>
                {
                    b.HasOne("Holonix.Server.Domain.Entities.WorkloadStatus", "WorkloadStatus")
                        .WithMany()
                        .HasForeignKey("WorkloadStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
